...
<html lang="en">
    ...
    <!-- NavBar -->
        ...
        <div class="container">
            ...
            <div class="col-md-12">
                <h3 class="titleIndex" align="center" style="margin-top : 100px;">Modify menu</h3>
                <nav class="nav flex-column">
                    <a class="nav-link active" href="modifyM.php">Market</a>
                    <a class="nav-link" href="modifyGestion.php">Market Administrator</a>
                    <a class="nav-link" href="modifyShipper.php">Delivery man</a>
                    </nav>
            </div>
        </div>
        </div>
