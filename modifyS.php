 <?php session_start();
    ...
    $idShipper = $_GET["id"];
    $sql ="SELECT * FROM user WHERE id_user = '$idShipper';";
    ...
    $email = $data["email"];
    setcookie("idGestion", $idShipper, time() + 1000);
    setcookie("exEmail", $email, time() + 1000);
    setcookie("idShipper", $idShipper, time() + 1000);
?>
<!DOCTYPE html>
<html lang="en">
    <head>
    ...
    <!-- NavBar -->
        ...
        <!-- add market -->
    <!-- Join Form -->
    <h2 style ="background-color:rgba(0,0,0,0.7); text-decoration : none; color:white; margin : 12px 33%;padding: 10px 10px; border-radius: 3px; border : solid 2px black;"align="center">Modify Delivery Man</h2>
        <form id="joinForm" method="post" action="modifySTreat.php" style ="color: white; background-color :rgba(0,0,0,0.6);">
  <div class="form-group" align="center">
    ...
    <div class="col-6">
        <button type="submit" class="btn btn-warning">Modify</button>
            ...
            <?php echo "<a href ='removeSTreat.php?id=".$idShipper."'"; ?>
