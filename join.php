...
<body style="background-image : url('slider/slide1.jpg');background-repeat : no-repeat;  background-size: 100% 100%;background-position: right 30% top -10% ;">    
    <!-- NavBar -->
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse justify-content-md-center col-9" id="navbarResponsive">
                    ...
                    <ul class="navbar-nav mr-auto">
                      ...
                      <div class="col-md-4">  
                          <!-- SearchBar -->
                    <form method="post" action="traitJoin.php">
        ...
        <!-- Join Form -->
    <h2 style ="background-color:rgba(0,0,0,0.7); text-decoration : none; color:white; margin : 12px 33%;padding: 10px 10px; border-radius: 3px; border : solid 2px black;"align="center">Join :</h2>
        <form id="joinForm" method="post" action="joinTreat.php" style ="color: white; background-color :rgba(0,0,0,0.6);">
