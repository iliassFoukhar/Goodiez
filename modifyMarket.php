 <?php session_start();
    ...
    $idMarket = $_GET["id"];
    $sql ="SELECT * FROM market WHERE id_market = '$idMarket';";
    $result = mysqli_query($link,$sql);
    $data = mysqli_fetch_assoc($result);
    $name = $data["name"];
    $adress = $data["adress"];
    $description = $data["description"];
    setcookie("idMarket", $idMarket, time() + 1000);
?>
<!DOCTYPE html>
<html lang="en">
    <head>
    ...
    <!-- NavBar -->
        ...
        <!-- add market -->
    <h2 style ="background-color:rgba(0,0,0,0.7); text-decoration : none; color:white; margin : 12px 33%;padding: 10px 10px; border-radius: 3px; border : solid 2px black;"align="center">Modify Market</h2>
        
        <form id="joinForm" method="post" enctype="multipart/form-data" action="modifyMTreat.php" style ="color: white; background-color :rgba(0,0,0,0.6);">
  <div class="form-group" align="center">
    <label for="firstname">Name :</label><br>
    <input type="text" class="form-control-md" name="name" size ="68" value=<?php echo "'".$name."'" ?> required>
      
  </div>
            <div class="form-group" align="center">
                    <label for="adress">Description :</label><br>
            <textarea id="msg" class="form-control z-depth-1" name="description" rows="3" cols = "20" required> <?php echo $description ?></textarea>
                </div>
            <div class="form-group" align="center">
                    <label for="adress">Adress :</label><br>
            <textarea id="msg" class="form-control z-depth-1" name="adress" rows="3" cols = "20" required> <?php echo $description ?> </textarea>
                </div>
    ...
    <div class="col-6">
        <button type="submit" class="btn btn-warning">Modify</button>
            ...
            <?php echo "<a href ='removeMTreat.php?id=".$idMarket."'"; ?>
