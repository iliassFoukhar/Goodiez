...
<html lang="en">
    ...
    <!-- NavBar -->
        ...
        <!-- add market -->
    <h2 style ="background-color:rgba(0,0,0,0.7); text-decoration : none; color:white; margin : 12px 33%;padding: 10px 10px; border-radius: 3px; border : solid 2px black;"align="center">Add Market</h2>
        <form id="joinForm" method="post" enctype="multipart/form-data" action="addMarket.php" style ="color: white; background-color :rgba(0,0,0,0.6);">
