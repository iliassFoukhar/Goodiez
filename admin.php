...
<html lang="en">
    ...
    <!-- NavBar -->
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse justify-content-md-center col-9" id="navbarResponsive">
                    ...
                    <ul class="navbar-nav mr-auto">
                        <li class="nav-item">
                            <a class="nav-link active" href="admin.php">Add<span style='color:#343a40;'>_</span></a>
                        </li>
                        <li class="nav-item">
        ...
        <div class="container">
            ...
            <div class="col-md-12">
                <h3 class="titleIndex" align="center" style="margin-top : 100px;">Add menu</h3>
                <nav class="nav flex-column">
                    <a class="nav-link active" href="addM.php">Market</a>
                    <a class="nav-link" href="addGestion.php">Market Administrator</a>
                    <a class="nav-link" href="addShipper.php">Delivery man</a>
                    </nav>
            </div>
        </div>
        </div>
