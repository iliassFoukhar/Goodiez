...
<html lang="en">
    ...
    <!-- NavBar -->
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse justify-content-md-center col-9" id="navbarResponsive">
                    ...
                    <ul class="navbar-nav mr-auto">
                        <li class="nav-item">
                            <a class="nav-link" href="gestionnaire.php">Catalogue<span style='color:#343a40;'>_</span></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link active" href="addCategory.php">Category<span style='color:#343a40;'>_</span></a>
                        </li>
                        <li class="nav-item">
        ...
        <div class="container">
            ...
            <div class="col-md-12">
                                    <h3 class="titleIndex" style="border : solid 3px white; margin-top: 75px;">Add a category</h3>

                    <form id="joinForm" method="post" action ="addCategoryTreat.php">
                    <div class="form-group">
                    <label for="exampleInputEmail1">Category's title</label>
