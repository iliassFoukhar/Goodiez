    ...
    <!-- NavBar -->
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse justify-content-md-center col-9" id="navbarResponsive">
                    ...
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="gainsAdmin.php">Gains</a>
                        </li>
                        <li></li>
                        <li></li>
                    </ul>
        ...
        <div class="row text-center">
            <div class="col-md-5 offset-md-1 overflow-auto ">                
                ...
                <h3 class="titleIndex" style="border : solid 3px white;">Turnovers</h3>
                <img class="aboutIcons" src="slider/CA.png"><br>
                    <hr class="light">
                    <?php 
                        include("connexion.php");
                        $sqlT = "SELECT DISTINCT * FROM market";
            ...
            <div class="col-md-5">
                ...
                <?php 
                        //pull delivery guys
                        include("connexion.php");
                        $sqlS = "SELECT * FROM commande WHERE command_state = 3;";
