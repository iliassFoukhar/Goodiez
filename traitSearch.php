    ...
    <!-- NavBar -->
        ...
        <!--search -->
                    ...
                    <?php 
                        ...
                        $searchy = $search."%";
                        $searchy1 = "%".$search."%";
                        $sql ="SELECT p.name, p.stock, p.unit_price, r.id_rubrique,p.image, p.id_Product,p.id_catalogue FROM product AS p INNER JOIN rubrique AS r ON p.id_rubrique = r.id_rubrique WHERE  p.name LIKE '$searchy' OR p.name LIKE '$searchy1';";
                        $result = mysqli_query($link, $sql);
                        echo '<div class="container-fluid">
                <div class="row text-center">
                <div class="col-md-12">
                    <h4 class="titleIndex">Search results for "'.$search.'"</h4>
                </div>';
                    ...
                    {
                        echo "<div class='container'><div class='row text-center'><div class='col-md-12' style ='margin-bottom : 300px;'><h3 class='error' align ='center'>No match for your search, try again.</h3></div></div>";
                    }
                    ?>
        </div>
        </div>
