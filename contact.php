...
<body style="background-image : url('slider/slide2.jpg');background-repeat : no-repeat;  background-size: 130% 130%;background-position: right 30% top 10%;">    <!-- NavBar -->
        <nav class="navbar navbar-expand-md navbar-dark bg-dark sticky-top">
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse justify-content-md-center col-8" id="navbarResponsive">
                    <div class="container">
                        <div class="col-md-5">
                   ...
                   <li class="px-3 py-3">
                       <form class="form" method="Post" action="treatLogin.php" role="form">
                            <div class="form-group">
                                <input id="login" placeholder="Login" class="form-control form-control-sm" type="text" required>
                            </div>
                            <div class="form-group">
                                <input id="password" placeholder="Password" class="form-control form-control-sm" type="password" required>
                            </div>
                            <div class="form-group">
        ...
        <!-- Contact Us -->
    <h2 style ="background-color:rgba(0,0,0,0.7); text-decoration : none; color:white; margin : 12px 33%;padding: 10px 10px; border-radius: 3px; border : solid 2px black;"align="center">Contact us :</h2>
        <form id="joinForm" method="post" action="contactTreat.php">
  <div class="form-group" align="center">
    <label for="fullName">Full Name :</label><br>
    <input type="text" class="form-control-md" name="fullname">
      
  </div>
    <div class="form-group" align="center">
    <label for="Company Name">Company Name :</label><br>
    <input type="text" class="form-control-md" name="company">
    <small id="passHelp" class="form-text text-muted">If you're representing one</small>
  </div>
        <div class="form-group" align="center">
    <label for="phone">Phone Number :</label><br>
    <input type="text" class="form-control-md" name="phone">
  </div>
            <div class="form-group" align="center">
    <label for="mail">Email :</label><br>
    <input type="email" class="form-control-md" name="mail">
  </div>
            <div class="form-group" align="center">
                    <label for="mail">Message :</label><br>

            <textarea id="msg" class="form-control z-depth-1" name="message" rows="3" cols = "20"></textarea>
                </div>
