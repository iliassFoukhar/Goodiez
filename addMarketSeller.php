...
<!-- NavBar -->
        ...
        <!-- add market -->
    <h2 style ="background-color:rgba(0,0,0,0.7); text-decoration : none; color:white; margin : 12px 33%;padding: 10px 10px; border-radius: 3px; border : solid 2px black;"align="center">Your Market</h2>
        <form id="joinForm" method="post" enctype="multipart/form-data" action="sellerMarketTreat.php" style ="color: white; background-color :rgba(0,0,0,0.6);">
  <div class="form-group" align="center">
    <label for="firstname">Name :</label><br>
    <input type="text" class="form-control-md" name="name" size ="68" required>
      
  </div>
            <div class="form-group" align="center">
                    <label for="adress">Description :</label><br>
            <textarea id="msg" class="form-control z-depth-1" name="description" rows="3" cols = "20" required></textarea>
                </div>
            <div class="form-group" align="center">
  ...
  <div class="custom-file">
    ...
    <label class="custom-file-label" for="inputGroupFile01" >A tiny picture</label>
  </div>
</div>
            <br>
            ...
            <div class="input-group">
  <div class="input-group-prepend">
    <span class="input-group-text" id="inputGroupFileAddon01">Portrait</span>
  </div>
  <div class="custom-file">
    <input type="file" class="custom-file-input" id="inputGroupFile01"
      aria-describedby="inputGroupFileAddon01" name="portrait">
    <label class="custom-file-label" for="inputGroupFile01" >An exterior picture</label>
  </div>
</div><br>
