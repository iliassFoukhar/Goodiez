<?php 
    ...
    //Insert everything into the Data Base
     ...
     `type`, `username`, `password`, `email`, `firstName`, `lastName`, `phone`, `adress`) VALUES ('$iDGE','3', '$username', '$password', '$email', '$firstName', '$lastName', '$phone', '$adress');";
    $sqlInsert2 ="INSERT INTO `goodiez`.`livreur` (`id_user`, `state`) VALUES ('$iDGE', 1);";
    ...
    if($passWrong == 1 && $notUnique == 1)
    {
        ...
        header('location:addShipper.php');
?>