...
<!-- NavBar -->
        ...
        <!-- Join Form -->
    <h2 style ="background-color:rgba(0,0,0,0.7); text-decoration : none; color:white; margin : 12px 33%;padding: 10px 10px; border-radius: 3px; border : solid 2px black;"align="center">Become a seller</h2>
        <form id="joinForm" method="post" action="addGTreatSeller.php" style ="color: white; background-color :rgba(0,0,0,0.6);">
